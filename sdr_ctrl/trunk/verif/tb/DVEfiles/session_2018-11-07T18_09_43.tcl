...
# DVE full session
# Saved on Wed Nov 7 18:09:02 2018
# Designs open: 0
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{7 51} {725 759}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 174} {height 396} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 174} {height 396} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
